	...
	class CXform : public CRefCount
	{
		...
		public:
			...
			enum EXformId
			{
				...
				ExfInnerJoin2IndexGetApply_removed,
				ExfInnerJoin2DynamicIndexGetApply_removed,
				...
				ExfInnerJoin2BitmapIndexGetApply_removed,
				ExfImplementPartitionSelector,
				ExfMaxOneRow2Assert,
				ExfInnerJoinWithInnerSelect2IndexGetApply_removed,
				ExfInnerJoinWithInnerSelect2DynamicIndexGetApply_removed,
				ExfInnerJoinWithInnerSelect2PartialDynamicIndexGetApply,
				ExfInnerJoin2DynamicBitmapIndexGetApply_removed,
				ExfInnerJoinWithInnerSelect2BitmapIndexGetApply_removed,
				ExfInnerJoinWithInnerSelect2DynamicBitmapIndexGetApply_removed,
				ExfGbAggWithMDQA2Join,
				ExfCollapseProject,
				ExfRemoveSubqDistinct,
				ExfLeftOuterJoin2BitmapIndexGetApply_removed,
				ExfLeftOuterJoin2IndexGetApply_removed,
				ExfLeftOuterJoinWithInnerSelect2BitmapIndexGetApply_removed,
				ExfLeftOuterJoinWithInnerSelect2IndexGetApply_removed,
				ExfExpandNAryJoinGreedy,
				ExfEagerAgg,
				ExfExpandNAryJoinDPv2,
				ExfImplementFullOuterMergeJoin,
				ExfLeftOuterJoin2DynamicBitmapIndexGetApply_removed,
				ExfLeftOuterJoin2DynamicIndexGetApply_removed,
				ExfLeftOuterJoinWithInnerSelect2DynamicBitmapIndexGetApply_removed,
				ExfLeftOuterJoinWithInnerSelect2DynamicIndexGetApply_removed,
